...
const getCityWeather = async(city) => {
    ...
    let now = new Date().getTime() / 1000; // 1 Jan 2025 - Unix period - in second
    // ova e sekogas razlicno vreme od koga sme ja povikale funkcijata, tocnoto vreme vo koja funkcijata 
    // bila povikana
    ...
    //20:32 -> ova ni e tret povik, tuka ovoj uslov nema da vazi i ke ni prodolzi so izvrsuvanj kodot
    // podolu vo fetch funkcijata za da povika podatci za gradot skopje koi ke bidat ponovi
    if(
        CACHE[city] &&
